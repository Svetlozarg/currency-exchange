...
<head>
    ...
    <title>{{ config('app.name', 'Currency Exchange') }}</title>
    ...
    <script src="https://cdn.datatables.net/buttons/1.7.0/js/buttons.bootstrap4.min.js" defer></script>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Currency Exchange') }}
                </a>
